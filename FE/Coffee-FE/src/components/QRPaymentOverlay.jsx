        ...
        <div className="flex-1 bg-gray-50 px-6 py-5 lg:px-10 lg:py-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-bold text-gray-900">Order #{order.id}</h2>
            </div>
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="rounded-3xl bg-white p-6 shadow-sm border border-gray-200">
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <div className="mt-6 flex h-72 w-72 items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white p-4">
                  {qrImageUrl ? (
                    <img src={qrImageUrl} alt="QR thanh toán" className="h-full w-full object-contain" />
                  ) : (
                ...
                <div className="mt-5 text-sm text-gray-500">
                  {isExpired ? "Mã QR đã hết hạn" : `Hết hạn sau ${minutes}:${seconds}`}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-3xl bg-white p-5 shadow-sm border border-gray-200">
                ...
                <div className="mt-3 space-y-2 text-sm text-gray-600">
                  ...
                  <p>3. Sau khi thanh toán thành công, hệ thống sẽ xác nhận đơn.</p>
                </div>
              </div>
          ...
          <div className="rounded-3xl bg-white p-5 shadow-sm border border-gray-200">
                ...
                <div className="mt-4 flex flex-col gap-3">
                  <button
                    ...
                    disabled={isExpired}
                    className="rounded-xl bg-amber-600 px-4 py-3 font-semibold text-white hover:bg-amber-700 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                  ...
                  <button
                    type="button"
                    onClick={onRefreshQr}
                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-300 px-4 py-3 font-medium text-gray-700 hover:bg-gray-50"
                  >
                    <RefreshCcw size={16} />
                    Làm mới QR
                  </button>
